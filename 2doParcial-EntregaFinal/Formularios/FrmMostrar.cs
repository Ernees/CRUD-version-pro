...
namespace Formularios
{
    public partial class FrmMostrar : Form
    {
        ...
        public FrmMostrar(Taller taller)
        {
            ...
            miTaller.Barcos = data.SeleccionarBarcos();
        ...
        private void btnModificar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    data.ModificarBarco(formModificar.BarcoFormulario);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (frmDel.ShowDialog() == DialogResult.OK)
            {
                ...
                data.EliminarBarco(frmDel.BarcoFormulario.Id);
                MessageBox.Show("(..) Eliminado con exito");
                this.miTaller.Barcos = data.SeleccionarBarcos();
                dataGridEmpleados.DataSource = this.miTaller.Barcos;
            }
        }
